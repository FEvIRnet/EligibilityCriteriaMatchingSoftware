const FOI32120checkBmi30399 = (bundledResourcesArray) => {
  let descriptor = "check if BMI 30-39.9 kg/m2";
      ...
      if (resource.valueQuantity) {
        if (resource.valueQuantity.code === "kg/m2" || resource.valueQuantity.unit === "kg/m2") {
          if (!resource.valueQuantity.comparator && resource.valueQuantity.value >= 30 && 
            resource.valueQuantity.value <= 39.9) {
            return { "result": "MATCH", "descriptor": descriptor };
          }
          if (!resource.valueQuantity.comparator && 
            (resource.valueQuantity.value < 30 || resource.valueQuantity.value > 39.9)) {
...
export default FOI32120checkBmi30399